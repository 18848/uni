...
<xsl:template match="/">
  ...
  <body>
	...
	<table class="tg">
		...
		<tbody>
			<xsl:for-each select="Root/Forecast/Day">
		<tr>
	...
	<table class="tg">
		...
		<tbody>
			<xsl:for-each select="Root/Prec-Max/Day">
		<tr>
		<td><xsl:value-of select="@data" /></td>
		<td><xsl:value-of select="Cidade" /></td>
		<td><xsl:value-of select="Maximo" /></td>
		</tr>
		</xsl:for-each>
		</tbody>
	</table>
	...
	<table class="tg">
		...
		<tbody>
			<xsl:for-each select="Root/Temp-Max/Day">
		<tr>
		<td><xsl:value-of select="@data" /></td>
		<td><xsl:value-of select="Cidade" /></td>
		<td><xsl:value-of select="Maximo" /></td>
	...
	<table class="tg">
		...
		<tbody>
			<xsl:for-each select="Root/Temp-Min/Day">
		<tr>
		<td><xsl:value-of select="@data" /></td>
		<td><xsl:value-of select="Cidade" /></td>
		<td><xsl:value-of select="Minimo" /></td>
		</tr>
		</xsl:for-each>
		</tbody>
	</table>
